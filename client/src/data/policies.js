// Client-side fallback mock data (mirrors server/data/policies.js)
const policies = [
  {
    id: 1,
    title: "Fuel Levy Increased by 15%",
    summary: "Government has approved a 15% increase in fuel levy effective next month. This affects petrol, diesel, and kerosene prices nationwide.",
    category: "transport",
    tags: [{ label: "Transport", direction: "up" }, { label: "Food Prices", direction: "up" }],
    ...
    deepExplanation: "The fuel levy is a tax added to every litre of fuel sold. When it goes up, the price at the pump increases immediately. But the ripple effects are bigger — since almost everything is transported by road, the cost of food, goods, and services tends to follow. For young people, this means higher trotro/Uber fares, pricier deliveries, and more expensive meals at your favorite spot.",
  },
  {
    id: 2,
    title: "E-Levy Officially Scrapped",
    summary: "The Electronic Transaction Levy (E-Levy) has been officially removed. Mobile money transactions will no longer attract the 1% charge.",
    category: "finance",
    tags: [{ label: "Mobile Money", direction: "down" }, { label: "Digital Payments", direction: "down" }],
    ...
    deepExplanation: "The E-Levy was a 1% tax on electronic transactions above a daily threshold. For a generation that lives on mobile money — splitting bills, paying for rides, receiving freelance income — this tax ate into every transaction. Its removal means that if you send GHS 100, the full GHS 100 arrives. No more hidden deductions.",
  },
  {
    id: 3,
    title: "Free SHS Program Expanded",
    summary: "Government announces expansion of Free Senior High School program with increased funding for STEM labs and digital infrastructure.",
    category: "education",
    tags: [{ label: "Education", direction: "neutral" }, { label: "STEM", direction: "up" }],
    ...
    deepExplanation: "Free SHS already removed tuition barriers, but quality gaps remained — especially in STEM. This expansion adds funding for science labs, computer rooms, and teacher training. For a country trying to build a digital economy, this is foundational.",
  },
  {
    id: 4,
    title: "New Rent Control Bill Passed",
    summary: "Parliament passes new rent control legislation capping annual rent increases at 10% and requiring 2-month notice before any increase.",
    category: "housing",
    tags: [{ label: "Rent", direction: "down" }, { label: "Housing", direction: "neutral" }],
    ...
    deepExplanation: "Ghana's rental market has been chaotic — landlords demanding 2-3 years advance rent, sudden 30-50% hikes, even evictions without notice. This new bill introduces real protections: a 10% cap on annual increases, mandatory 2-month notice before changes, and a formal complaint mechanism.",
  },
  {
    id: 5,
    title: "National Health Insurance Covers Mental Health",
    summary: "NHIS now covers outpatient mental health consultations, counseling sessions, and basic psychiatric medication.",
    category: "health",
    tags: [{ label: "Mental Health", direction: "up" }, { label: "Healthcare", direction: "neutral" }],
    ...
    deepExplanation: "Mental health has been severely underfunded in Ghana — the entire country has fewer than 100 psychiatrists. By adding mental health to NHIS coverage, the government is acknowledging that anxiety, depression, and stress are real health issues, not 'weakness.'",
  },
  {
    id: 6,
    title: "Digital Addressing System Now Mandatory",
    summary: "All businesses and residences must register with the Ghana Digital Address system. Delivery services must integrate GPS-based addresses.",
    category: "technology",
    tags: [{ label: "Tech", direction: "up" }, { label: "E-Commerce", direction: "up" }],
    ...
    deepExplanation: "Ever tried to describe your location in Ghana? 'Turn left at the blue kiosk, then ask for Auntie Grace's house.' The Digital Addressing System assigns a unique code to every 5-meter square in the country. Making it mandatory means e-commerce can actually deliver to your door.",
  },
];
